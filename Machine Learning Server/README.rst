...
==========================================================
A  stand-alone sever in flask for machine Leaning in Python. 
The machine learning sever is complete with model build implementing randomforest algorithm. This server can be integrated to any application. Any request received by the server pointing to a data file, a response will be generated by classifying the activity based on the label id provided.
